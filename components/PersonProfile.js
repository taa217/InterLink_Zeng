...
function PersonProfile(){
    return(
        <div className={styles.container}>
          ...
          <div className={styles.it}><div className={styles.profile}><div></div><Image src="/postpics/pp.jpg" width={150} height={150} objectFit="cover" alt="profile" className={styles.profileimg} /></div>
